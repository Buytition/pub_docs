...
For any created EBA that has received emails from buyer or seller, EBA's author or buying project author will be able to check all email communications for that EBA only. 
