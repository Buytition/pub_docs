...
## <<step-4-2-one-click-turn-on-off-agent, One Click Mute/UnMute Dealer Emails>>

Once an Email Buyer Agent is created, you can mute (or unsubscribe from) all emails sent to the agent's email address with one click, without need to fill out any unsubscribe form at all.  You may unmute all dealer emails at any time later, also with one click.
...
## <<step-3-communicate-with-dealer-via-proxy-email, Reply Directly From Your Mailbox>>

after an Email Buyer Agent is created, you just wait for dealer emails and respond to dealer directly from your personal email account.

## <<step-41-check-buyer-agent-emails, Organize Email Communications Around Your Target Vehicles>>

Each forwarded emails to or from dealers will be tagged with your target vehicle link.
