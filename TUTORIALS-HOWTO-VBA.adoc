...
This is a powerful feature offered by <<what-is-email-buyer-agent, Email Buyer Agent (EBA)>> to empower not only buyer him/herself, but also buyer's one or multiple friends to collaborate with buyer to email negotiate a deal with seller.  After a Buying Project is created by a buyer, not only the buyer (project author) him/herself may add EBA, but the buyer's friends are also allowed to contribute to the project by adding EBA to it.  If an EBA is added by a friend of buyer, then the details of EBA including all email messages of EBA can be accessed by not only buyer's friend but also the buyer him/herself.  All seller emails sent to EBA proxy email address will not only be forwarded to buyer's friend but also buyer him/herself so that both buyer and buyer's friend participate in the negotiation with seller using email.  And because one buying project may have unlimited number of EBA added to it, multiple friends of buyer may add multiple EBA to it respectively, while each EBA can be only accessed by the creator friend and the buyer i.e. project author, all the created EBA can be accessed by buyer who created the project so the buyer can oversee and participate into negotiation processes of all EBA added to the project.
