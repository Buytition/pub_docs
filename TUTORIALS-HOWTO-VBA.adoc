...
With all research, home-work and negotiation work needed, do you feel that buying a large-ticket item such as car, piano is like working on a project?  Will it be a little easier if you have a tool to manage this project?  Would it be even better if that tool happens to also makes it easy for other people to collaborate to help you find better deal than the deal you have got?  If you answer yes to these questions, https://buytition.com/projects/show-form/start-project[Buying Project] is exactly the kind of tool you are looking for.

Buying Project is developed by https://buytition.com[Buytition] for buyers to create a public page for multiple purposes:
