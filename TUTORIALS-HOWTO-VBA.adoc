...
If you agree that buying a large-ticket item such as car, piano is like working on a project, then you will need a tool to manage that project; if that tool also makes it easy for other people to collaborate and help you to find better deal for what you are trying to buy, is it even better?  If you answer yes to these questions, Buying Project is exactly the kind of tool you are looking for.
