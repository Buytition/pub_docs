...
Owner of price records have access to public, private and dedicated mailbox information of the price records and also receives majority of <<for-sellers-ownership-of-price-record,sale proceeds>> if someone purchases the price records on sale.
