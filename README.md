...
* Edmunds PricePromise email (see sample email body [here](https://github.com/Buytition/pub_docs/blob/master/raw-text/inbox-201912120906-edmunds-pricepromise.html)): extract dealer, vehicle, price quote and MSRP information automatically
...
* Edmunds PricePromise Emails, example: for this [inbound email message](https://github.com/Buytition/pub_docs/blob/master/raw-text/inbox-201912120906-edmunds-pricepromise.html), Reply Bot will generate this [outbound email message](https://github.com/Buytition/pub_docs/blob/master/raw-text/sent-201912120906-edmunds-pricepromise.md).